...
const ChartSection = ({ selectedPatient, diagnosisHistory }) => {
  ...
  return (
    ...
    >
      ...
      <h3 style={{ marginBottom: "20px", color: "#333", textAlign: "left" }}>
        Blood Pressure 
      </h3>
  ...
  <div style={{ backgroundColor: "#F5F5FA", padding: "20px", borderRadius: "10px", width: "25%", lineHeight: "1.5",marginTop:"-90px" }}>
    <h4 style={{ color: "#333", fontWeight: "bold", marginBottom: "16px" }}>Blood Pressure</h4>
    <div style={{ marginBottom: "20px" }}>
      <span style={{ color: "#A64CA6", fontSize: "18px", fontWeight: "bold" }}>Systolic</span>
      <div style={{ fontSize: "36px", color: "#333", fontWeight: "bold" }}>{avgSystolic.toFixed(2)}</div>
      <div style={{ fontSize: "14px", color: "#333" }}>Higher than Average</div>
    </div>
    <div>
      <span style={{ color: "#644CA6", fontSize: "18px", fontWeight: "bold" }}>Diastolic</span>
      <div style={{ fontSize: "36px", color: "#333", fontWeight: "bold" }}>{avgDiastolic.toFixed(2)}</div>
      <div style={{ fontSize: "14px", color: "#333" }}>Lower than Average</div>
    </div>
  </div>
</div>
